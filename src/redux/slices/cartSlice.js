...
const cartSlice = createSlice({
   ...
   reducers: {
      ...
      changeCartToggleStatus: (state, action) => {
         state.cartToggleStatus = action.payload
      }
   }, 
...
export const { addToCart, decreaseCart, getTotals, clearCart, changeCartToggleStatus } = cartSlice.actions;
